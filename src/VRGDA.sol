...
contract VRGDA {
    ...
    function getPrice(uint256 timeSinceStart, uint256 numSold)
        public
        view
        returns (uint256)
    {
        ...
        //TODO: link to white paper explaining manipulation
        int256 initial = logisticScale.div(
            PRBMathSD59x18.fromInt(1) + timeScale.mul(timeShift).exp()
        );
        int256 logistic_value = PRBMathSD59x18.fromInt(int256(numSold + 1)) +
            initial;
