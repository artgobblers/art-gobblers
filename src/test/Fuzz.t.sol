...
contract FuzzTest is DSTestPlus {
    ...
    //// function overflowSafegetLogisticPrice(uint256 timeSinceStart, uint256 id) public view returns (uint256) {
    ////     return
    ////         uint256(
    ////             wadMul(
    ////                 initialPrice,
    ...
    // function testgetLogisticPriceOverflowSafety(uint256 timeSinceStart, uint256 id) public {
    //     uint256 result1;
    //     bool reverted1;

    //     try gobblers.getLogisticPrice(bound(timeSinceStart, 0, ONE_THOUSAND_YEARS), bound(id, 0, 7990)) returns (
    //         uint256 price1
    //     ) {
    //         result1 = price1;
    //     } catch {
    ...
    //     try gobblers.overflowSafegetLogisticPrice(bound(timeSinceStart, 0, ONE_THOUSAND_YEARS), bound(id, 0, 7990)) returns (
    //         uint256 price2
    //     ) {
    //         result2 = price2;
    //     } catch {
    ...
    // //         gobblers.getLogisticPrice(timeSinceStart, 7990);
    // //     }
    // // }
    ...
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 0 days, 269 days), 7990);
    // }

    // function testFailOverflowTooLateForLastGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 23374 days, ONE_THOUSAND_YEARS), 7990);
    // }

    // function testSweetSpotForLastGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 270 days, 1032 days), 7990);
    // }
    ...
    // //        timeSinceStart += 1 days;
    // //        emit log_uint(timeSinceStart / 1 days);
    // //        gobblers.getLogisticPrice(timeSinceStart, 0);
    // //     }
    // // }

    // function testFailOverflowTooLateForFirstGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 452 days, ONE_THOUSAND_YEARS), 0);
    // }

    // function testSweetSpotForFirstGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 0 days, 451 days), 0);
    // }
    ...
    // //         timeSinceStart += 1 days;
    // //         emit log_uint(timeSinceStart / 1 days);
    // //         gobblers.getLogisticPrice(timeSinceStart, 3395);
    // //     }
    // // }

    // function testFailOverflowTooLateForMidGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 507 days, ONE_THOUSAND_YEARS), 3395);
    // }

    // function testSweetSpotForMidGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 0 days, 506 days), 3395);
    // }
    ...
    // //         timeSinceStart += 1 days;
    // //        emit log_uint(timeSinceStart / 1 days);
    // //        gobblers.getLogisticPrice(timeSinceStart, 6700);
    // //    }
    // // }

    // function testFailOverflowTooLateForUpperMidGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 598 days, ONE_THOUSAND_YEARS), 6700);
    // }

    // function testSweetSpotForUpperMidGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 0 days, 597 days), 6700);
    // }

    // /////////////////////////////////////////////////////////////////////////

    // function testSweetSpotForAllGobblers(uint256 timeSinceStart, uint256 id) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 275 days, 451 days), bound(id, 0, 7990));
    // }

    // function testFailOverflowTooLateForAllGobblers(uint256 timeSinceStart, uint256 id) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 1033 days, ONE_THOUSAND_YEARS), bound(id, 0, 7990));
    // }

    // /////////////////////////////////////////////////////////////////////////

    // function testFailOverflowBeyondLastGobbler(uint256 timeSinceStart) public {
    //     gobblers.getLogisticPrice(bound(timeSinceStart, 0 days, ONE_THOUSAND_YEARS), 7991);
    // }
}
